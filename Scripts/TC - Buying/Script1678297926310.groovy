...
if (tc_item_1 == 'Sauce Labs Backpack') {
...
if (tc_item_2 == 'Sauce Labs Bike Light') {
    Mobile.tap(findTestObject('Object Repository/SWAG - Buying/add_bikeLight'), 0)

    Mobile.scrollToText('Sauce Labs Backpack', FailureHandling.STOP_ON_FAILURE)
}

if (tc_item_1 == 'Sauce Labs Fleece Jacket') {
...
if (tc_item_2 == 'Sauce Labs Onesie') {
...
Mobile.setText(findTestObject('Object Repository/SWAG - Buying/android.widget.EditText - Last Name'), 'agad', 0)

Mobile.setText(findTestObject('Object Repository/SWAG - Buying/android.widget.EditText - ZipPostal Code'), '55252', 0)
